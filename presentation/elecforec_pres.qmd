...
*Brown & Chappell* proposed a model averaging weighting two models by their 
posterior model evidence. The **hist** equation represents structural model, 
while the **poll** equation is the polling model
